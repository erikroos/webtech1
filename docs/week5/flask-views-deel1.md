...
!!! info "Waar zijn we?"
    Met Flask en formulieren (week 3) verzamel je gebruikersinvoer, en met SQL (week 4) sla je gegevens blijvend op. Deze week brengen we die twee werelden samen: de Flask-applicatie van muziekschool Sessions krijgt een echte databasekoppeling.

## Database koppeling

Je hebt in week 4 al met SQLite gewerkt: tabellen, rijen, kolommen en SQL queries. Die kennis is hier direct van toepassing. Het verschil is de aanpak: in week 4 schreef je de SQL zelf, hier gebruik je een ORM.
