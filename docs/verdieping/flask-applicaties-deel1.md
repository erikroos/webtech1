...
- **`uv export`**: commando om de vastgelegde pakketten naar requirements.txt te exporteren; `uv add -r requirements.txt` installeert ze opnieuw in een nieuwe omgeving
